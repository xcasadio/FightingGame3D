...
namespace GameEngine
{
	 ...
	 *
	 */
	class GAME_ENGINE_EXPORT cSound
	{
	  protected:
	 ...
	 *
	 */
	class GAME_ENGINE_EXPORT cSoundData
	{
	 ...
	 *
	 */
	class GAME_ENGINE_EXPORT cSoundChannel
	{
	  friend class cSound;
	 ...
	 *
	 */
	class GAME_ENGINE_EXPORT cMusicChannel
	{
	  friend class cSound;
	 ...
	 *
	 */
	typedef struct GAME_ENGINE_EXPORT sWaveHeader
	{
	  char  RiffSig[4];
